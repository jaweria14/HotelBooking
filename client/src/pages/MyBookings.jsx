        ...
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] gap-4 w-full border-b border-gray-300 py-6 first:border-t'>
                        {/* ........Hotel details........ */}
                        <div className='flex flex-col md:flex-row'>
                            <img
                                src={booking.room.images[0]}
                                alt="hotel-img"
                                className='w-full h-40 md:w-30 md:h-30 rounded-lg shadow object-cover'
                            />
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            ...
                            {/* to show the the payemnet button */}
                            {!booking.isPaid && (
