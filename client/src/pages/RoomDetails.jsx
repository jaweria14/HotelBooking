            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="date" id='checkInDate' placeholder='Check-In' className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outlinne-none ' required />
                    </div>
                    {/* verticle line */}
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="date" id='checkOutDate' placeholder='Check-In' className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outlinne-none ' required />
                    </div>
                    {/* verticle line*/}
                    <div className='hidden md:block w-px h-12 bg-gray-300/70'></div>
                    {/* third div  */}
                    <div className="flex flex-col">
                        ...
                        <input type="number" id='guest' placeholder='0' className='max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5 ' required />
                    </div>
