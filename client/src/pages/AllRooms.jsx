...
// compnnet radio button 
const RadioButton = ({label, selected = false, onChange = () => { }}) => {
    return (
        <label className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
            <input 
                type="radio" 
                checked={selected} name='sortOption'
...
{filteredRooms.length === 0 ? (
    <div className="py-20 text-center">
        <h2 className="text-2xl font-playfair text-gray-800">
            No hotel registered in {searchParams.get('destination')}
        </h2>

        <p className="text-gray-500 mt-2">
            Please try searching for another destination.
        </p>
    </div>
) : (
    filteredRooms.map((room) => ( 
      ...
      {/* Filters */}
      <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 ml-8'>
