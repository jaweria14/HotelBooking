...
const [inputs, setInputs] = useState({
   ...
   const onSubmitHandler = async (e) => {
    ...
    if (
        ...
        !Object.values(inputs.amenities).some((amenity) => amenity) ||
    ...
    try {
        ...
        // and keeping only enabled Amenities
  ...
  <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
    {Object.keys(images).map((key)=>(
      <label htmlFor={`roomImage${key}`} key={key}>
        <img className='max-h-14 w-32 cursor-pointer opacity-80 hover:opacity-100 border-gray-300 rounded-lg'
