...
function decodeAutoconfigTokenV1(token) {
	if (!token.startsWith(AUTOCONFIG_TOKEN_PREFIX_V1)) throw new AutoConfigError();
...
//#endregion
export { ApiException, AppPortalCapability, AutoConfig, AutoConfigConsumer, AutoConfigError, BackgroundTaskStatus, BackgroundTaskType, ConnectorKind, ConnectorProduct, HTTPValidationError, HttpErrorOut, MessageAttemptTriggerType, MessageStatus, MessageStatusText, Ordering, SinkStatus, SinkStatusIn, StatusCodeClass, Svix, ValidationError, Webhook, WebhookVerificationError, messageInRaw };
